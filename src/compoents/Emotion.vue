<template>
	<div class="container">
		...
		<section class="main">
			<ul class="timeline">
				<li class="event" v-for="(item, index) in quarterData" :key="index">
			...
			<div
				style="color:rebeccapurple; padding-left: 115px; font-weight: bold;font-size: 20px; padding-top: 20px;; padding-bottom: 20px;">
				- 未完待续 -</div>
		</section>
	</div><!-- /container -->
</template>
